...
CY,CZ=3.21,1.80          # shell centerline offset (from detection)
...
A=imp(SP+"/leg4_aligned_4A.stl"); A.name="shellA"
B=imp(SP+"/leg4_aligned_4B.stl"); B.name="shellB"
...
export(A,SP+"/leg4_enclosed_4A.stl")
export(B,SP+"/leg4_enclosed_4B.stl")
export(toe,SP+"/leg4_enclosed_toecover.stl")
