...
CY,CZ=-2.22,1.56          # shell centerline offset (from detection)
...
A=imp(SP+"/leg5_aligned_5A.stl"); A.name="shellA"
B=imp(SP+"/leg5_aligned_5B.stl"); B.name="shellB"
...
export(A,SP+"/leg5_enclosed_5A.stl")
export(B,SP+"/leg5_enclosed_5B.stl")
export(toe,SP+"/leg5_enclosed_toecover.stl")
