...
def L(p):
    ...
    return m
A=L(SP+"/leg4_aligned_4A.stl"); B=L(SP+"/leg4_aligned_4B.stl")
...
json.dump({"centerline":[round(cy,3),round(cz,3)],"report":report},open(SP+"/_enc_report_leg4.json","w"),indent=1)
np.save(SP+"/_shell_rout_leg4.npy",{"r_out":r_out,"cy":cy,"cz":cz,"NX":NX,"NT":NT})
print("\nsaved _enc_report_leg4.json + _shell_rout_leg4.npy")
